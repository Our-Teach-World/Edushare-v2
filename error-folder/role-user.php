...
<head>
  ...
  <title>Role and Username Error | Account Login</title>
      ...
      <div class="card-content">
        ...
        <div >
          <div class="error-content">
            ...
            <div>
              <p class="error-title">Invaild Username and role</p>
              <p class="error-description">The Username and role not matched. Please try again.</p>
            </div>
          </div>
        </div>
        ...
        <button id="tryAgainButton" class="try-again">
          ...
          <a href="../login.php">Click here to back</a> <pre>  </pre>
        </button>
