...
<body>
          ...
          <form id="registrationForm" action="registerdb.php" method="POST" class="space-y-4">
            ...
            <div id="step1" class="space-y-4 input-wrapper">
              ...
              <div class="space-y-2">
                ...
                <input id="username" name="username" placeholder="Enter Username" required minlength="6"
                  class="input" />
                <span class="icon">
              ...
              <div class="space-y-2 input-wrapper">
                ...
                <input id="password" name="password" type="password" required minlength="4" class="input" />
            ...
            <div class="mt-6 flex justify-between">
              <button type="button" id="backButton" class="btn btn-outline" style="display: none;"
                onclick="goBack()">Back</button>
              <button type="button" id="nextButton" class="btn btn-primary ml-auto"
                onclick="validateAndNext()">Next</button>
              <button type="submit" id="registerButton" class="btn btn-primary ml-auto" style="display: none;"
  ...
  <footer class="footer">
    <div class="container">
      <p class="text-xs text-center text-muted-foreground">© <span id="currentYear"></span> EduShare. All rights
        reserved.</p>
    </div>
  </footer>
